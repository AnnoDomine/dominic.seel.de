...
suited my needs so I created this enhanced one. I want to create a README template so amazing that
...
pull request or opening an issue. Thanks to all the people have contributed to expanding this
template!
...
See the [open issues](https://github.com/othneildrew/Best-README-Template/issues) for a full list of
